...
func TestOfficialAnnotationKeywordFixtures(t *testing.T) {
	t.Parallel()
	...
	fixtures := []dialectFixture{
		{directory: "draft3", dialect: jsonschema.Draft3, files: []string{"default.json"}},
		{directory: "draft4", dialect: jsonschema.Draft4, files: []string{"default.json"}},
		{
			directory: "draft6",
			dialect:   jsonschema.Draft6,
			files:     []string{"default.json", "boolean_schema.json"},
		},
		{
			directory: "draft7",
		...
		},
		{
			...
			files:     []string{"default.json", "content.json", "boolean_schema.json"},
		},
		{
